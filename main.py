...
test_X, test_Y = data_encode("iris.test") # Dataset de validação

# Configuraões da MLP
learning_rate = 0.01  # Taxa de aprendizado
training_epochs = 5000  # Epoca
n_input = 4  # Número de valores de entrada
n_hidden = 10  # Número de neurônios na camada oculta
n_output = 3  # Número de neurônios na camada de saida
